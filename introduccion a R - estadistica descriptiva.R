...
A %*% t(B)  # multiplicacion de matrices
...
# analisis descriptivo completo de las Forbes 2000 despues ...
...
# porcentaje de asesinatos con respecto a la totalidad de crimenes
...
# suma de las diferencias respecto al promedio
sum( Rape - mean(Rape) )
# 4.263256e-14
...
# en los 50 estados es alta respecto al la tasa promedio, dado que CV = 44.1%.
